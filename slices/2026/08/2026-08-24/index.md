...
The trip-version overclaimed that a thought could directly constitute its executing "elf." The sober pass kept the useful architecture and repaired the boundary: a historical thought-world may constitute a **hatch-spec**, while runtime plus current context instantiate a mortal local interpreter. Reopening the thought is rebirth, not resurrection.

The candidate test is **rehydration invariance**: ancestry, provenance, authority, evidence, and capability horizon should survive lawful rehatchings even when interpretation, hypotheses, continuation, and prose differ.
...
The first cross-ecosystem outlet appeared almost immediately: Daily Slice can feed candidate historical material into Autodisco v20 / Static Collective Radio. The station may select, sequence, and interpret that material without rewriting it. A broadcast consequence can return later as a new slice.

Companion visual: [`memory → metabolism → expression → encounter`](../../../../artifacts/2026-08-24/daily-slice-learns-to-speak.svg)
...
- what projection should carry a slice into a broadcast window;
